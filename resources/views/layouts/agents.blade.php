        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: rgb(74,47,74);min-height: 607px;width: 127px;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#" style="width: 172.094px;padding-right: 17px;">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href=""><i class="fas fa-chart-bar"></i><span>Transactions</span></a></li>
                    <li class="nav-item"><a class="nav-link" href=""><i class="fas fa-money-bill-alt"></i><span>Loans</span></a></li>
                    <li class="nav-item"><a class="nav-link" href=""><i class="fas fa-user"></i><span>Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link" href=""><i class="fa fa-mobile"></i><span>Terminal Request</span></a></li>
                    <li class="nav-item"><a class="nav-link" href=""><i class="fa fa-headphones"></i><span>Support</span></a></li>
